...
const hasDep = dep => {
  ...
  else if (pkg.devDependencies && pkg.devDependencies[dep]) return true;
  else if (pkg.peerDependencies && pkg.peerDependencies[dep]) return true;
  else return false;
};
